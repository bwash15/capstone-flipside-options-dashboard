import filtersApi from '../api/aggFilters';
...
const HandleFiltersSubmit = async ({ snapShotBaseUrl, aggFilters, setAggFilters, setAggregatesLink, setOptionTickerLink, setSnapShotLink, option_type, option_expire_date, option_ticker, option_strike_price, option_multiplier, option_timespan, option_from, option_to, option_ticker_link }) => {
    ...
    try {
        ...
        const allFilters = [...aggFilters, filtersResponse];
        setAggFilters(allFilters);
