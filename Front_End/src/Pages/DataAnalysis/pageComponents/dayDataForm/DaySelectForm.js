...
const DaySelectForm = ({ title, change, setChange, change_percent, setChangePercent, close, setClose, high, setHigh, last_updated, setLast_updated, low, setLow, open, setOpen, previous_close, setPreviousClose, volume, setVolume, vwap, setVwap, _handleDayHold }) => {
    return (
        <p>
