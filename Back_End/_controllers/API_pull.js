...
// const PullHistoricalOptions = async () => {
//   const option_type = 'C'                             //C for call P for put
//   const option_expire_date = '220427'                 // YearMonthDay
//   const option_ticker = 'SPY';                       //nasdaq name for the company -> this comapny is called exela but the nasdaq name is XELA
//   const option_strike_price = '00428000';             //8 digit number, divide by 1000 -> this will be 1$
...
//   const from = '2022-04-24';                          //start of the timeframe to look at
//   const to = '2022-04-25';                            //end of the timefraconst
//   const api_link = `https://api.polygon.io/v2/aggs/ticker/${options_ticker_link}/range/${multiplier}/${timespan}/${from}/${to}?apiKey=${api_key}`;
//   const snapshot_link = `https://api.polygon.io/v3/snapshot/options/${option_ticker}/O:${option_ticker}${option_expire_date}${option_type}${option_strike_price}?apiKey=${api_key}`
